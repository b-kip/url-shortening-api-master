...
function App() {
  ...
  <main>
    ...
    <section className="call-to-action bg-dark-violet">
      <div className="container flow-content">
        <h2 className="call-to-action__message">Boost your links today</h2>
        <button className="btn btn--accent">Get Started</button>
      </div>
    </section>
  ...
  <footer className="footer">
    <div className="container">
      <div className="footer__content-container">
        <a href="/" className="logo"><img src={logoWhite} alt="logo white"/></a>
        <div className="footer__links">
          <h3 className="footer__links__title">Features</h3>
      ...
      <div className="attribution">
        ...
        Coded by <a href="https://github.com/b-kip/api-shortening" target="_blank" rel="noreferrer">b-kip</a>.
      </div>
    </div>
  </footer>
    </div>
